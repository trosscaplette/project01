                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('emp.register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cname" type="text" class="form-control @error('cname') is-invalid @enderror" name="cname" value="{{ old('name') }}" required autocomplete="name" autofocus>
